...
import styles from "./Menubar_style.css";
...
const AppTopbar = (props) => {
    ...
    const items2 = [
        ...
        },
        {
            ...
            command: () => history.push("/project"),
        },
    ];

    if (!props.user?.isAdmin) {
        items2[1].command = () => history.push("/post-project");
    }
    if (props.user?.isAdmin) {
        items2.push({
            label: 'Pending Project',
            icon: 'pi pi-fw pi-folder',
            command: () => history.push("/post-project"),
        })
        items2.push({
            label: 'Users',
    ...
    return (
        <div className="layout-topbar">
            ...
            {/* menubar */}
            <Menubar className={styles.menubar} model={items2} />
            {/* menubar end  */}
